...
const LandingPage = () => {
    ...
    return (
        <Grid container direction="column" className={classes.mainContainer}>
                ...
                <Grid item>
                    ...
                    <Grid container direction="row" className={classes.serviceContainer}
                        ...
                        <Grid item style={{textAlign: matchesSM ? "center" : undefined}}>
                            ...
                            <Typography variant="subtitle1">
                                Integrate your web experience or create standalone app {matchesSM ? null : <br/>} with
                                either mobile
                                platform
                            </Typography>
                            <Button variant="outlined" className={classes.learnButton}>
            ...
            <Grid item>
                {/*----- Revolution Block----- */}
                <Grid container style={{height: "50em", marginTop: "10em"}} justify="center" alignItems="center">
